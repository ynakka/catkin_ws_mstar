...
(cl:in-package mstar_navigation-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <State6>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'State6)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mstar_navigation-msg:<State6> is deprecated: use mstar_navigation-msg:State6 instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <State6>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mstar_navigation-msg:header-val is deprecated.  Use mstar_navigation-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'state_x-val :lambda-list '(m))
(cl:defmethod state_x-val ((m <State6>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mstar_navigation-msg:state_x-val is deprecated.  Use mstar_navigation-msg:state_x instead.")
  (state_x m))

(cl:ensure-generic-function 'state_y-val :lambda-list '(m))
(cl:defmethod state_y-val ((m <State6>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mstar_navigation-msg:state_y-val is deprecated.  Use mstar_navigation-msg:state_y instead.")
  (state_y m))

(cl:ensure-generic-function 'state_theta-val :lambda-list '(m))
(cl:defmethod state_theta-val ((m <State6>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mstar_navigation-msg:state_theta-val is deprecated.  Use mstar_navigation-msg:state_theta instead.")
  (state_theta m))

(cl:ensure-generic-function 'state_dx-val :lambda-list '(m))
(cl:defmethod state_dx-val ((m <State6>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mstar_navigation-msg:state_dx-val is deprecated.  Use mstar_navigation-msg:state_dx instead.")
  (state_dx m))

(cl:ensure-generic-function 'state_dy-val :lambda-list '(m))
(cl:defmethod state_dy-val ((m <State6>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mstar_navigation-msg:state_dy-val is deprecated.  Use mstar_navigation-msg:state_dy instead.")
  (state_dy m))

(cl:ensure-generic-function 'state_dtheta-val :lambda-list '(m))
(cl:defmethod state_dtheta-val ((m <State6>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mstar_navigation-msg:state_dtheta-val is deprecated.  Use mstar_navigation-msg:state_dtheta instead.")
  (state_dtheta m))
