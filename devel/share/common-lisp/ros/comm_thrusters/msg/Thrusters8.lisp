...
(cl:in-package comm_thrusters-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <Thrusters8>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Thrusters8)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name comm_thrusters-msg:<Thrusters8> is deprecated: use comm_thrusters-msg:Thrusters8 instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <Thrusters8>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader comm_thrusters-msg:header-val is deprecated.  Use comm_thrusters-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'FXpMZp-val :lambda-list '(m))
(cl:defmethod FXpMZp-val ((m <Thrusters8>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader comm_thrusters-msg:FXpMZp-val is deprecated.  Use comm_thrusters-msg:FXpMZp instead.")
  (FXpMZp m))

(cl:ensure-generic-function 'FXpMZm-val :lambda-list '(m))
(cl:defmethod FXpMZm-val ((m <Thrusters8>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader comm_thrusters-msg:FXpMZm-val is deprecated.  Use comm_thrusters-msg:FXpMZm instead.")
  (FXpMZm m))

(cl:ensure-generic-function 'FXmMZp-val :lambda-list '(m))
(cl:defmethod FXmMZp-val ((m <Thrusters8>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader comm_thrusters-msg:FXmMZp-val is deprecated.  Use comm_thrusters-msg:FXmMZp instead.")
  (FXmMZp m))

(cl:ensure-generic-function 'FXmMZm-val :lambda-list '(m))
(cl:defmethod FXmMZm-val ((m <Thrusters8>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader comm_thrusters-msg:FXmMZm-val is deprecated.  Use comm_thrusters-msg:FXmMZm instead.")
  (FXmMZm m))

(cl:ensure-generic-function 'FYpMZp-val :lambda-list '(m))
(cl:defmethod FYpMZp-val ((m <Thrusters8>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader comm_thrusters-msg:FYpMZp-val is deprecated.  Use comm_thrusters-msg:FYpMZp instead.")
  (FYpMZp m))

(cl:ensure-generic-function 'FYpMZm-val :lambda-list '(m))
(cl:defmethod FYpMZm-val ((m <Thrusters8>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader comm_thrusters-msg:FYpMZm-val is deprecated.  Use comm_thrusters-msg:FYpMZm instead.")
  (FYpMZm m))

(cl:ensure-generic-function 'FYmMZp-val :lambda-list '(m))
(cl:defmethod FYmMZp-val ((m <Thrusters8>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader comm_thrusters-msg:FYmMZp-val is deprecated.  Use comm_thrusters-msg:FYmMZp instead.")
  (FYmMZp m))

(cl:ensure-generic-function 'FYmMZm-val :lambda-list '(m))
(cl:defmethod FYmMZm-val ((m <Thrusters8>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader comm_thrusters-msg:FYmMZm-val is deprecated.  Use comm_thrusters-msg:FYmMZm instead.")
  (FYmMZm m))
